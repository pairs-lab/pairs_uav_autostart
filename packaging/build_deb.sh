...
# dependency .debs from /prebuilt, then builds pairs_uav_autostart and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_uav_autostart/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_autostart
